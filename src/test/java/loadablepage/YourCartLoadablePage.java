...
public class YourCartLoadablePage extends BaseLoadablePage {
    public YourCartLoadablePage(WebDriver driver) {
        super(driver);
    }

    @Override
    public boolean isPageOpened() {
        return driver.findElement(ITEM_PRICE).isDisplayed();
    }
